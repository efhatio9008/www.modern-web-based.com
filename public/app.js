  ...
  data.forEach(p => {
    table.innerHTML += `
      <tr>
        ...
        <td>
          <input id="desc-${p.id}" value="${p.project_description || ""}">
        </td>

        <td>
          <input id="status-${p.id}" value="${p.status || ""}">
        </td>

        <td>
          <input id="remarks-${p.id}" value="${p.remarks || ""}">
        </td>

        <td>
          ${p.si_report ? `<span>Uploaded ✅</span>` : `<span>No file</span>`}
          <br>
